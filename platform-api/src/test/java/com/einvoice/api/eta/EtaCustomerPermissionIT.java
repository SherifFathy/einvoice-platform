...
class EtaCustomerPermissionIT {
    ...
    void setUp() {
        Company company = companyRepository.save(Company.builder()
                .nameEn("Perm Co").nameAr("شركة").taxNumber("PERM001").isActive(true).build());
    ...
    void viewerCanGetButCannotPostPutDelete() throws Exception {
        User viewer = User.builder()
                .name("Viewer")
                .email("viewer@eta-customer-perm.com")
        ...
        mockMvc.perform(put("/api/companies/{companyId}/eta/customers/{customerId}",
    ...
    void adminMode_rejectedWithCompanyContextRequired() throws Exception {
        User superUser = User.builder()
                .name("Super")
                .email("super@eta-customer-perm.com")
                .passwordHash(passwordEncoder.encode("P"))
                .isSuperUser(true)
                .isActive(true)
                .build();
