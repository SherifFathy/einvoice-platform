...
@Testcontainers
class ZatcaStandardHappyPathIT {
    ...
    void setUp() {
        Company company = companyRepository.save(Company.builder()
                .nameEn("ZATCA Test Co").nameAr("اختبار")
                .taxNumber("ZT001").isActive(true).build());
        companyId = company.getId();

        User user = User.builder()
                .name("Test Admin")
                .email("ztest@test.com")
    ...
    @Test
    void createSubmitRetrieveHappyPath() throws Exception {
        var line = Map.of(
                "lineNumber", 1,
        ...
        String body = objectMapper.writeValueAsString(Map.of(
                "invoiceNumber", "STD-HP-" + System.nanoTime(),
                "invoiceTypeCode", "388",
        ...
        when(engine.prepareStandardSubmission(any(),
                        any(), any()))
