...
class ZatcaRetryIdempotencyIT {
    ...
    void setUp() {
        Company company = companyRepository.save(Company.builder()
                .nameEn("Retry Test Co").nameAr("اختبار")
                .taxNumber("RT001").isActive(true).build());
    ...
    @Test
    void retryAfterAmbiguousProducesNewAttemptWithoutChainAdvance()
            throws Exception {
        var line = Map.of(
                "lineNumber", 1,
                "description", "Service",
        ...
        String body = objectMapper.writeValueAsString(Map.of(
                "invoiceNumber", "STD-RT-" + System.nanoTime(),
                "invoiceTypeCode", "388",
