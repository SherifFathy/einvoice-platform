...
@Testcontainers
class ZatcaSimplifiedHappyPathIT {
    ...
    void setUp() {
        Company company = companyRepository.save(Company.builder()
                .nameEn("ZATCA Simplified Test Co").nameAr("اختبار مبسط")
                .taxNumber("ZTS001").isActive(true).build());
        companyId = company.getId();

        User user = User.builder()
                .name("Test Simplified Admin")
    ...
    @Test
    void createSubmitRetrieve_noBuyer_reportingStatus() throws Exception {
        var line = Map.of(
                "lineNumber", 1,
        ...
        String body = objectMapper.writeValueAsString(Map.of(
                "invoiceNumber", "SIMP-HP-" + System.nanoTime(),
                "invoiceTypeCode", "388",
        ...
        when(engine.prepareSimplifiedSubmission(any(),
                        any(), any()))
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.status")
                        .value("ACCEPTED"))
                .andExpect(
                        jsonPath("$.reportingStatus")
                                .value("REPORTED"))
                .andExpect(
                        jsonPath("$.invoiceCounterValue")
                                .value(1));
    }
}
