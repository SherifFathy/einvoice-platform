...
/**
 * ZATCA Standard (B2B) invoice ingestion request — UBL Fatoora v2.0.3 shape.
 * Buyer is required for Standard invoices. Header-level allowances are
 * materialised into {@code zatca_standard_allowances} by the ingestion service.
 */
public record ZatcaStandardInvoiceIngestionRequest(
        ...
        @NotBlank @Pattern(regexp = "1[01]{3}0000") String transactionTypeCode,
        @NotNull LocalDate issueDate,
        @NotNull LocalTime issueTime,
        @NotNull @Valid SellerParty seller,
        @NotNull @Valid BuyerParty buyer,
    ...
    /**
     * Seller party for a ZATCA Standard invoice.
    ...
    /**
     * Buyer party for a ZATCA Standard invoice. All fields are required
     * (Standard = B2B, buyer identity is mandatory per UBL BR-KSA-EN16931-04).
     */
     ...
     * {@code zatca_standard_allowances} by the ingestion service.
     */
     ...
     * {@code zatca_standard_line_allowances}.
     */
     ...
     * {@code zatca_standard_line_allowances} by the ingestion service.
     */
