    ...
    <div class="list-container">
      ...
      <table mat-table [dataSource]="documents()?.items ?? []">
        ...
        <ng-container matColumnDef="invoiceNumber">
          ...
          <td mat-cell *matCellDef="let row">
            <ng-container *appHasPermission="['STANDARD', 'VIEW']; else plainInvoiceNumber">
              <a [routerLink]="['/standard', row.id]" class="doc-link">
                {{ row.invoiceNumber }}
              </a>
            </ng-container>
...
export class ZatcaStandardListComponent {
  ...
  private readonly emptyResult: ZatcaStandardListResult = {
