...
/** JPA entity for ZATCA standard per-rate tax subtotal (BG-23). */
@Entity
@Table(name = "zatca_standard_tax_subtotals")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ZatcaStandardTaxSubtotal {
    ...
    private ZatcaStandardHeader header;
