...
@DataJpaTest
@Testcontainers
class ZatcaSimplifiedSpecificationsTest {
    ...
    @Autowired
    private ZatcaSimplifiedHeaderRepository repository;
    ...
    void filtersByCompanyAndEnvironment() {
        insertHeader(companyId, authEnvId, "SIMP-001",
                DocumentState.DRAFT);
        insertHeader(otherCompanyId, authEnvId, "SIMP-002",
                DocumentState.DRAFT);

        Specification<ZatcaSimplifiedHeader> spec =
                ZatcaSimplifiedSpecifications
                        .inActiveTenantAndAssignedCompany(
                                List.of(companyId), authEnvId);
        Page<ZatcaSimplifiedHeader> page = repository.findAll(spec,
                PageRequest.of(0, 50));
    ...
    void filtersByEnvironment() {
        insertHeader(companyId, authEnvId, "SIMP-SB",
                DocumentState.DRAFT);
        insertHeader(companyId, otherAuthEnvId, "SIMP-PR",
                DocumentState.DRAFT);
    ...
    void filtersByStatus() {
        insertHeader(companyId, authEnvId, "SIMP-D",
                DocumentState.DRAFT);
        insertHeader(companyId, authEnvId, "SIMP-A",
        ...
        Specification<ZatcaSimplifiedHeader> spec =
                ZatcaSimplifiedSpecifications
                        .inActiveTenantAndAssignedCompany(
                                List.of(companyId), authEnvId)
                        .and(ZatcaSimplifiedSpecifications.inState(
                                DocumentState.DRAFT));
        Page<ZatcaSimplifiedHeader> page = repository.findAll(spec,
                PageRequest.of(0, 50));
    ...
    void filtersByDateRange() {
        insertHeader(companyId, authEnvId, "SIMP-OLD",
                DocumentState.DRAFT,
                LocalDate.of(2026, 1, 15));
        insertHeader(companyId, authEnvId, "SIMP-NEW",
                DocumentState.DRAFT,
        ...
        Specification<ZatcaSimplifiedHeader> spec =
                ZatcaSimplifiedSpecifications
                        .inActiveTenantAndAssignedCompany(
                                List.of(companyId), authEnvId)
                        .and(ZatcaSimplifiedSpecifications.issuedBetween(
